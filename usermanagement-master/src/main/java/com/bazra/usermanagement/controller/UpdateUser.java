...
public class UpdateUser {
	...
	public ResponseEntity<?> updatePhoto(@RequestParam("fileImage") MultipartFile photo,@RequestParam("fileID") MultipartFile id,@RequestBody UserInfoUpdateRequest request,Authentication authentication ) throws IOException {
